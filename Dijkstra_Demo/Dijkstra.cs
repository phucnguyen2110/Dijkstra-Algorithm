...
namespace Dijkstra_Demo
{
    public class Dijkstra
    {
        ...
        public void DijkstraSimple(ListView lv, ListView lvtable, int n, int s, int e, out bool isPath, RichTextBox txb, List<Point> pt, 
            List<Form1.Segment> segment, List<Form1.Segment> tmp, List<int> _segment, List<List<Form1.Segment>> Segment_Review, bool undirected)
        {
            tmp.Clear();
            txb.Clear();
            lvtable.Clear();
